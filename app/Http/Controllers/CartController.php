                        ...
                        <h4>ORDER SUMMARY</h4>
                         ...
                         <div class="product_details mt-5 borderOrdd">
                           <ul class="ps-0">
                               <div class="row">
                                   <div class="col-md-6">
                                     <li><img src='.asset('frontend/images/free-delivery.png').' alt="">Fast Free Shipping</li>
                                     <li><img src='.asset('frontend/images/fast.png').' alt="">Fast Express Shipping</li>
                                     <li><img src='.asset('frontend/images/returning.png').' alt="">Hassle Free Return</li>
                                     <li><img src='.asset('frontend/images/checkmark.png').' alt="">Authenticity Guaranteed</li>
                                                                      </div>
                                   <div class="col-md-6">
                                   <li><img src='.asset('frontend/images/shield.png').' alt="">Safe &amp; Secure Checkout</li>
                                     <li><img src='.asset('frontend/images/available.png').' alt="">In Stock and Ready to Ship</li>
                                   </div>
                               </div>
                             </ul>
                         </div>
