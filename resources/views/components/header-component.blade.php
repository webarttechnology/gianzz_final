		...
		<div class="mainMenu">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5">
						<ul class="ps-0 mt-4 ">
							<li><a href="{{ url('') }}" id="home_active" class="activeCat">Home</a></li>
							<li><a href="{{ url('about-us') }}" id="aboutus_actice" >About us</a></li>
							<li><a href="{{ url('shop') }}" id="shop_active" >Shop now</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<div class="logo">
